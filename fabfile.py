...
DEPLOYMENTS = {
    'stage': {
        ...
        'host_string': 'ubuntu@stage.qlands.com',
        'project': 'ona',
        'key_filename': os.path.expanduser('~/.ssh/ona.pem'),
        'celeryd': '/etc/init.d/celeryd-ona',
        'django_config_module': 'formshare.settings.local_settings',
        'pid': '/var/run/ona.pid',
        'template': 'git@github.com:onaio/formshare-template.git',
    },
    'prod': {
        'home': '/home/ubuntu/src/',
        'host_string': 'ubuntu@qlands.com',
        'project': 'ona',
        'key_filename': os.path.expanduser('~/.ssh/ona.pem'),
        'celeryd': '/etc/init.d/celeryd-ona',
        'django_config_module': 'formshare.settings.local_settings',
