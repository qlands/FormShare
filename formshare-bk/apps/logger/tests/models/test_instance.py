...
from formshare.apps.logger.models import XForm, Instance
from formshare.apps.logger.models.instance import get_id_string_from_xml_str
from formshare.apps.viewer.models import ParsedInstance
from formshare.libs.utils.common_tags import MONGO_STRFTIME, SUBMISSION_TIME,\
