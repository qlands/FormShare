...
from formshare.apps.logger.import_tools import import_instances_from_zip
...
from formshare.apps.logger.models.ziggy_instance import ZiggyInstance
from formshare.libs.utils.log import audit_log, Actions
from formshare.libs.utils.viewer_tools import enketo_url
from formshare.libs.utils.logger_tools import (
...
from formshare.libs.utils.user_auth import helper_auth_helper, has_permission,\
...
def edit_data(request, username, id_string, data_id):
    ...
    try:
        ...
        if url:
            ...
            return HttpResponseRedirect(url)
    return HttpResponseRedirect(
        reverse('formshare.apps.main.views.show',
                kwargs={'username': username,
                        'id_string': id_string}))
