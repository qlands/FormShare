...
def upgrade():
    ...
    op.add_column('odkform', sa.Column('form_abletomerge', sa.INTEGER(), server_default=sa.text("'-1'"), nullable=True))
    op.add_column('odkform', sa.Column('form_mergetask', sa.Unicode(length=64), nullable=True))
