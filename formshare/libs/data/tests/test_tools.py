...
from formshare.libs.data.query import get_form_submissions_grouped_by_field,\
...
class TestTools(TestBase):
    ...
    @patch('formshare.apps.logger.models.instance.submission_time')
    ...
    def test_get_form_submissions_two_xforms(self, mock_time):
        ...
        self._make_submission(os.path.join(
            'formshare', 'apps', 'main', 'tests', 'fixtures', 'gps',
    ...
    def test_get_field_records_when_some_responses_are_empty(self):
        ...
        for i in submissions:
            self._make_submission(os.path.join(
                'formshare', 'apps', 'api', 'tests', 'fixtures', 'forms',
