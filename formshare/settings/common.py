...
DEFAULT_FROM_EMAIL = 'noreply@qlands.com'
SHARE_PROJECT_SUBJECT = '{} FormShare Project has been shared with you.'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'formshare.apps.main.context_processors.google_analytics',
    'formshare.apps.main.context_processors.site_name'
)

MIDDLEWARE_CLASSES = (
    'formshare.libs.profiling.sql.SqlTimingMiddleware',
    'django.middleware.common.CommonMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',
    # 'django.middleware.locale.LocaleMiddleware',
    'formshare.libs.utils.middleware.LocaleMiddlewareWithTweaks',
    'django.middleware.csrf.CsrfViewMiddleware',
    'corsheaders.middleware.CorsMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.transaction.TransactionMiddleware',
    'formshare.libs.utils.middleware.HTTPResponseNotAllowedMiddleware',
    'readonly.middleware.DatabaseReadOnlyMiddleware',
)

LOCALE_PATHS = (os.path.join(PROJECT_ROOT, 'formshare.apps.main', 'locale'), )

ROOT_URLCONF = 'formshare.apps.main.urls'
USE_TZ = True
...
INSTALLED_APPS = (
    ...
    'taggit',
    'readonly',
    'formshare.apps.logger',
    'formshare.apps.viewer',
    'formshare.apps.main',
    'formshare.apps.restservice',
    'formshare.apps.api',
    'guardian',
    'djcelery',
    'formshare.apps.stats',
    'formshare.apps.sms_support',
    'formshare.libs',
)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'formshare.libs.authentication.DigestAuthentication',
        'formshare.libs.authentication.TempTokenAuthentication',
...
AUTH_PROFILE_MODULE = 'formshare.apps.main.UserProfile'

# case insensitive usernames
AUTHENTICATION_BACKENDS = (
    'formshare.apps.main.backends.ModelBackend',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'audit': {
            'level': 'DEBUG',
            'class': 'formshare.libs.utils.log.AuditLogHandler',
            'formatter': 'verbose',
            'model': 'formshare.apps.main.models.audit.AuditLog'
        },
        # 'sql_handler': {
        #     'level': 'DEBUG',
        #     'class': 'logging.StreamHandler',
...
GOOGLE_STEP2_URI = 'http://www.qlands.com'
GOOGLE_CLIENT_ID = '617113120802.formshare.apps.googleusercontent.com'
...
CELERY_IMPORTS = ('formshare.libs.utils.csv_import',)
