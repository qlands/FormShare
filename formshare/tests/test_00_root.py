...
from .steps.geoJSON import t_e_s_t_geo_json, t_e_s_t_generated_geo_json
...
from .steps.project_qr import t_e_s_t_project_qr
from .steps.config_switches import t_e_s_t_config_switches
from .steps.api_token import t_e_s_t_api_token_user, t_e_s_t_api_token_assistant
from .steps.htmx_partials import t_e_s_t_htmx_partials
from .steps.es_scripts import t_e_s_t_es_scripts
from .steps.exit_codes import t_e_s_t_exit_codes
from .steps.es_indexes import t_e_s_t_es_indexes
from .steps.settings_at_startup import t_e_s_t_settings_at_startup
...
class FunctionalTests(unittest.TestCase):
    def setUp(self):
        ...
        self.test_object.assistantLoginUUID = ""
        self.test_object.assistantLogin2UUID = ""
        self.test_object.caseassistantUUID = ""
    ...
    def test_all(self):
        ...
        if run_whole_suite:
            print("Testing project QR settings")
            t_e_s_t_project_qr(self.test_object)
            print("Testing configuration switches")
            t_e_s_t_config_switches(self.test_object)
            print("Testing settings read at startup")
            t_e_s_t_settings_at_startup(self.test_object)
            print("Testing the API with a user token")
            t_e_s_t_api_token_user(self.test_object)
            ...
            print("Testing htmx partial updates")
            t_e_s_t_htmx_partials(self.test_object)
            print("Testing GeoJSON")
            t_e_s_t_geo_json(self.test_object)
            print("Testing GeoJSON generated by a plugin")
            t_e_s_t_generated_geo_json(self.test_object)
            ...
            print("Testing the form checker's exit codes")
            t_e_s_t_exit_codes(self.test_object)
            ...
            print("Testing the case-management journey")
            t_e_s_t_case_journey(self.test_object)
            ...
            print("Testing the API with an assistant token")
            t_e_s_t_api_token_assistant(self.test_object)
            ...
            print("Testing ElasticSearch export and import")
            t_e_s_t_es_scripts(self.test_object)
            print("Testing ElasticSearch index creation")
            t_e_s_t_es_indexes(self.test_object)
