...
CREATE TABLE IF NOT EXISTS `formshare`.`project` (
  ...
  `project_cdate` DATETIME NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `formshare`.`odkform`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `formshare`.`odkform` (
  `project_id` VARCHAR(64) NOT NULL,
  ...
  CONSTRAINT `fk_form_parent_project_form`
    ...
    REFERENCES `formshare`.`odkform` (`project_id` , `form_id`),
...
-- -----------------------------------------------------
-- Table `formshare`.`fsuser`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `formshare`.`fsuser` (
...
-- -----------------------------------------------------
-- Table `formshare`.`userproject`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `formshare`.`userproject` (
  `user_id` VARCHAR(120) NOT NULL,
  `project_id` VARCHAR(64) NOT NULL,
  `access_type` INT(11) NULL,
  `access_date` DATETIME NULL,
  PRIMARY KEY (`user_id`, `project_id`),
  INDEX `fk_userproject_project1_idx` (`project_id` ASC),
  CONSTRAINT `fk_userproject_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `formshare`.`fsuser` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
