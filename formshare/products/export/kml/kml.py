...
def generate_kml_file(request, user, project, form, form_schema, primary_key):
    ...
    task = build_kml.apply_async((settings, form_schema, kml_file, primary_key, request.locale_name), countdown=2)
    register_product_instance(request, user, project, form, 'kml_export', task.id, kml_file,
