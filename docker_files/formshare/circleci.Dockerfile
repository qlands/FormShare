...
RUN sudo git clone https://github.com/qlands/odktools.git -b stable-2.5
...
RUN sudo chown -R circleci /opt/formshare_repository
RUN sudo chown -R circleci /opt/formshare_log
RUN sudo chown -R circleci /opt/formshare_celery
RUN sudo chown -R circleci /opt/formshare_gunicorn
RUN sudo chown -R circleci /opt/formshare_config
RUN sudo ldconfig
USER circleci
