...
from formshare.apps.api.permissions import UserProfilePermissions
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/profiles

> Response
>
>       [
>        {
>            "url": "https://formshare.qlands.com/api/v1/profiles/demo",
>            "username": "demo",
>            "name": "Demo User",
>            "email": "demo@localhost.com",
>            "city": "",
...
>            "require_auth": false,
>            "user": "https://formshare.qlands.com/api/v1/users/demo"
>            "metadata": {},
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/profiles/demo
...
>
>     \
curl -X PATCH -d '{"country": "KE"}' https://formshare.qlands.com/api/v1/profiles/demo \
...
>       curl -X POST -d current_password=password1 -d new_password=password2\
 https://formshare.qlands.com/api/v1/profile/demouser/change_password
> Response:
>
>        HTTP 200 OK
"""
