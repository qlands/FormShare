...
from formshare.apps.main.views import profile, download_media_data
from formshare.apps.logger.models import Instance, XForm
from formshare.apps.logger.views import formList, download_xform, xformsManifest
from formshare.libs.utils.briefcase_client import BriefcaseClient
