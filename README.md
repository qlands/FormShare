...
Releases
------------
The current stable release is 2.8.2 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.8.2) 

The database signature for stable 2.8.2 is 3dd1ebdcd7e0

The Docker image for stable 2.8.2 is 20210503
...
cd /opt
sudo mkdir formshare_docker_compose_20210503
cd formshare_docker_compose_20210503
sudo wget https://raw.githubusercontent.com/qlands/FormShare/stable-2.8.2/docker_compose/docker-compose.yml
...
cd /opt/formshare_docker_compose_20210503
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20210503/docker-compose.yml
...
# Copy the current docker compose file to a new one. For example, [current_docker_image] could be 20210503 and [new_docker_image] will be 20210503
cd /opt
sudo cp -R formshare_docker_compose_[current_docker_image] formshare_docker_compose_[new_docker_image]

# Edit the /opt/formshare_docker_compose_[new_docker_image]/docker-compose.yml and change all the references of [current_docker_image] to [new_docker_image]. For example change all  20210503 for 20210503
# If you are upgrading from Docker images <= 20210503 to images > 20210503 then you need to also update the Docker image of Elasticsearch to 6.8.14
