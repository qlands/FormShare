...
from formshare.libs.serializers.chart_serializer import (
    ChartSerializer, FieldsChartSerializer)
from formshare.libs.utils import common_tags
from formshare.libs.utils.chart_tools import build_chart_data_for_field
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/charts
...
>            "id": 4240,
>            "id_string": "dhis2form"
>            "url": "https://formshare.qlands.com/api/v1/charts/4240",
>        }
>        ...
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/charts/4240
...
>            "url": "https://formshare.qlands.com/api/v1/charts/4240",
>            "fields": {
>                "uuid": "https://formshare.qlands.com/api/v1/charts/4240?field_name=uuid",
>                "num": "https://formshare.qlands.com/api/v1/charts/4240?field_name=num",
>                ...
>            }
>        }
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/charts/4240.html?field_name=age
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/charts/4240?fields=all
