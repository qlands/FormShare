...
from formshare.apps.api.permissions import MetaDataObjectPermissions
from formshare.apps.api.tools import get_media_file_response
from formshare.apps.main.models.meta_data import MetaData
from formshare.libs.serializers.metadata_serializer import MetaDataSerializer
...
class MetaDataViewSet(LastModifiedMixin, viewsets.ModelViewSet):
        ...
        [
            {
                ...
                "id": 406,
                "url": "https://formshare.qlands.com/api/v1/metadata/406",
                "xform": 328
            },
            {
                ...
                "data_value": "a.png",
                "id": 7100,
                "url": "https://formshare.qlands.com/api/v1/metadata/7100",
                "xform": 320
            },
            ....
        ]
    ...
    GET /api/v1/metadata/<code>{pk}</code></pre>
        ...
        curl -X GET https://formshare.qlands.com/api/v1/metadata/7100
    ...
    GET /api/v1/metadata/<code>{pk}.{format}</code></pre>
        ...
        curl -X GET https://formshare.qlands.com/api/v1/metadata/7100.png -o a.png
...
"example||https://api.tiles.mapbox.com/v3/examples.map-0l53fhk2.json||example\
 attribution", "xform": 320}" https://formshare.qlands.com/api/v1/metadata \
...
.map-0l53fhk2.json||example attribution",
            ...
            "data_file": null,
            "data_file_type": null,
            "url": "https://formshare.qlands.com/api/v1/metadata/7119.json"
            }

    Media upload example:

            curl -X POST -F 'data_type=media' -F 'data_value=demo.jpg' \
-F 'xform=320' -F "data_file=@folder.jpg" https://formshare.qlands.com/api/v1/metadata.json
            ...
            "url": "https://formshare.qlands.com/api/v1/metadata/7121.json"
            }
