...
from formshare.apps.logger.views import view_submission_list
from formshare.apps.logger.views import view_download_submission
from formshare.apps.logger.views import form_upload
