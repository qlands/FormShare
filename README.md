...
Releases
------------
The current stable release is 2.6.13 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.6.13) 

The database signature for stable 2.6.13 is 135c7989d4b0

The Docker image for stable 2.6.13 is 20201129
...
cd /opt
sudo git clone https://github.com/qlands/FormShare.git -b stable-2.6.13 formshare_source

# Copy the docker compose file from the source to a new directory
sudo mkdir formshare_docker_compose_20201129
sudo cp ./formshare_source/docker_compose/docker-compose.yml ./formshare_docker_compose_20201129/
...
cd /opt/formshare_docker_compose_20201129
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20201129/docker-compose.yml
