...
Releases
------------
The current stable release is 2.13.0 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.13.0) 

The database signature for stable 2.13.0 is ebe16efbc30f

The Docker image for stable 2.13.0 is 20220407
...
cd /opt
sudo mkdir formshare_docker_compose_20220407
cd formshare_docker_compose_20220407
sudo wget https://raw.githubusercontent.com/qlands/FormShare/stable-2.13.0/docker_compose/docker-compose.yml
...
cd /opt/formshare_docker_compose_20220407
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20220407/docker-compose.yml
