...
from formshare.apps.main.forms import UserProfileForm, FormLicenseForm,\
...
from formshare.apps.main.models import AuditLog, UserProfile, MetaData
from formshare.apps.logger.models import Instance, XForm
from formshare.apps.logger.views import enter_data
from formshare.apps.viewer.models.data_dictionary import DataDictionary,\
    upload_to
from formshare.apps.viewer.models.parsed_instance import\
    DATETIME_FORMAT, ParsedInstance
from formshare.apps.viewer.views import attachment_url
from formshare.apps.sms_support.tools import check_form_sms_compatibility,\
    is_sms_related
from formshare.apps.sms_support.autodoc import get_autodoc_for
from formshare.apps.sms_support.providers import providers_doc
from formshare.libs.utils.bamboo import get_new_bamboo_dataset,\
    delete_bamboo_dataset, ensure_rest_service
from formshare.libs.utils.decorators import is_owner
from formshare.libs.utils.logger_tools import response_with_mimetype_and_name,\
    publish_form
from formshare.libs.utils.user_auth import add_cors_headers
from formshare.libs.utils.user_auth import check_and_set_user_and_form
from formshare.libs.utils.user_auth import check_and_set_user
from formshare.libs.utils.user_auth import get_xform_and_perms
from formshare.libs.utils.user_auth import has_permission
from formshare.libs.utils.user_auth import helper_auth_helper
from formshare.libs.utils.user_auth import set_profile_data
from formshare.libs.utils.log import audit_log, Actions
from formshare.libs.utils.qrcode import generate_qrcode
from formshare.libs.utils.viewer_tools import enketo_url
from formshare.libs.utils.export_tools import upload_template_for_external_export
