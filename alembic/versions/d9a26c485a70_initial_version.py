...
def upgrade():
    ...
    op.create_table('collaborator',
                    ...
                    sa.ForeignKeyConstraint(['samas_project', 'sameas_coll'], ['collaborator.project_id', 'collaborator.coll_id'], name=op.f('fk_collaborator_samas_project_collaborator')),
    ...
    op.create_table('odkform',
                    ...
                    sa.Column('extra', sa.UnicodeText(), nullable=True),
                    sa.Column('tags', sa.UnicodeText(), nullable=True),
                    sa.ForeignKeyConstraint(['parent_project', 'parent_form'], ['odkform.project_id', 'odkform.form_id'], name=op.f('fk_odkform_parent_project_odkform')),
                    sa.ForeignKeyConstraint(['project_id'], ['project.project_id'], name=op.f('fk_odkform_project_id_project'), ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('project_id', 'form_id', name=op.f('pk_odkform')),
                    mysql_charset='utf8',
                    mysql_engine='InnoDB'
                    )
    op.create_index('fk_form_form1_idx', 'odkform', ['parent_project', 'parent_form'], unique=False)
    op.create_table('userproject',
                    sa.Column('user_id', sa.Unicode(length=120), nullable=False),
                    sa.Column('project_id', sa.Unicode(length=64), nullable=False),
                    sa.Column('access_type', sa.INTEGER(), nullable=True),
                    sa.Column('access_date', sa.DateTime(), nullable=True),
                    sa.ForeignKeyConstraint(['project_id'], ['project.project_id'], name=op.f('fk_userproject_project_id_project')),
                    sa.ForeignKeyConstraint(['user_id'], ['fsuser.user_id'], name=op.f('fk_userproject_user_id_fsuser')),
                    sa.PrimaryKeyConstraint('user_id', 'project_id', name=op.f('pk_userproject')),
                    mysql_charset='utf8',
                    mysql_engine='InnoDB'
                    )
    op.create_index(op.f('ix_userproject_project_id'), 'userproject', ['project_id'], unique=False)
    ...
    op.create_table('formaccess',
                    ...
                    sa.Column('coll_privileges', sa.INTEGER(), nullable=True),
                    sa.Column('access_date', sa.DateTime(), nullable=True),
                    sa.ForeignKeyConstraint(['form_project', 'form_id'], ['odkform.project_id', 'odkform.form_id'], name=op.f('fk_formaccess_form_project_odkform'), ondelete='CASCADE'),
    ...
    op.create_table('formgrpaccess',
                    ...
                    sa.Column('form_id', sa.Unicode(length=120), nullable=False),
                    sa.Column('access_date', sa.DateTime(), nullable=True),
                    sa.ForeignKeyConstraint(['form_project', 'form_id'], ['odkform.project_id', 'odkform.form_id'], name=op.f('fk_formgrpaccess_form_project_odkform'), ondelete='CASCADE'),
    ...
    op.create_table('jsonlog',
                    ...
                    sa.Column('enum_project', sa.Unicode(length=64), nullable=False),
                    sa.Column('coll_id', sa.Unicode(length=120), nullable=False),
                    sa.ForeignKeyConstraint(['enum_project', 'coll_id'], ['collaborator.project_id', 'collaborator.coll_id'], name=op.f('fk_jsonlog_enum_project_collaborator')),
                    sa.ForeignKeyConstraint(['project_id', 'form_id'], ['odkform.project_id', 'odkform.form_id'], name=op.f('fk_jsonlog_project_id_odkform'), ondelete='CASCADE'),
    ...
    op.create_table('septable',
                    ...
                    sa.ForeignKeyConstraint(['project_id', 'form_id'], ['odkform.project_id', 'odkform.form_id'], name=op.f('fk_septable_project_id_odkform'), ondelete='CASCADE'),
    ...
    op.create_table('submission',
                    ...
                    sa.ForeignKeyConstraint(['enum_project', 'coll_id'], ['collaborator.project_id', 'collaborator.coll_id'], name=op.f('fk_submission_enum_project_collaborator')),
                    sa.ForeignKeyConstraint(['project_id', 'form_id'], ['odkform.project_id', 'odkform.form_id'], name=op.f('fk_submission_project_id_odkform'), ondelete='CASCADE'),
    ...
    op.create_table('jsonhistory',
                    ...
                    sa.Column('enum_project', sa.Unicode(length=64), nullable=False),
                    sa.Column('coll_id', sa.Unicode(length=120), nullable=False),
                    sa.ForeignKeyConstraint(['enum_project', 'coll_id'], ['collaborator.project_id', 'collaborator.coll_id'], name=op.f('fk_jsonhistory_enum_project_collaborator')),
                    sa.ForeignKeyConstraint(['form_id', 'project_id', 'log_id'], ['jsonlog.form_id', 'jsonlog.project_id', 'jsonlog.log_id'], name=op.f('fk_jsonhistory_form_id_jsonlog'), ondelete='CASCADE'),
