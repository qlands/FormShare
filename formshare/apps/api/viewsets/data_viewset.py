...
from formshare.apps.api.viewsets.xform_viewset import custom_response_handler
from formshare.apps.api.tools import add_tags_to_instance
from formshare.apps.logger.models.xform import XForm
from formshare.apps.logger.models.instance import Instance
...
from formshare.libs.serializers.data_serializer import (
    DataSerializer, DataListSerializer, DataInstanceSerializer)
from formshare.libs import filters
from formshare.libs.utils.viewer_tools import (
    EnketoError,
    get_enketo_edit_url)
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/data
...
>            "url": "https://formshare.qlands.com/api/v1/data/4240"
>         },
>            ...
>        ]
...
>
>       curl -O https://formshare.qlands.com/api/v1/data.csv
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/data?owner=formshare
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/data/22845
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/data/22845/4503
...
> Example
>
>       curl -X GET 'https://formshare.qlands.com/api/v1/data/22845?query={"kind": \
"monthly"}'
>       curl -X GET 'https://formshare.qlands.com/api/v1/data/22845?query={"date": \
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/data/22845?tags=monthly
...
>
>       curl -X DELETE \
https://formshare.qlands.com/api/v1/data/28058/20/labels/tag1
or to delete the tag "hello world"
>
>       curl -X DELETE \
https://formshare.qlands.com/api/v1/data/28058/20/labels/hello%20world
>
> Response
>
>        HTTP 200 OK
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/data/public
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/data/28058/20/enketo?return_url=url
...
> Example
>
>       curl -X DELETE https://formshare.qlands.com/api/v1/data/28058/20
