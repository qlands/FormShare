...
Releases
------------
The current stable release is 2.6.6 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.6.6) 

The database signature for stable 2.6.6 is be94ab1faa43

The Docker image for stable 2.6.6 is 20200708
...
cd /opt
sudo git clone https://github.com/qlands/FormShare.git -b stable-2.6.6 formshare_source

# Copy the docker compose file from the source to a new directory
sudo mkdir formshare_docker_compose_20200708
sudo cp ./formshare_source/docker_compose/docker-compose.yml ./formshare_docker_compose_20200708/
...
cd /opt/formshare_docker_compose_20200708
sudo docker-compose pull

# Edit the docker-compose.yml file to set the mysql root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20200708/docker-compose.yml
