...
from formshare.apps.logger.models.instance import (
    FormInactiveError,
    InstanceHistory,
    get_id_string_from_xml_str)
from formshare.apps.logger.models import XForm
from formshare.apps.logger.models.xform import XLSFormError
from formshare.apps.logger.xform_instance_parser import (
    InstanceEmptyError,
...
from formshare.apps.viewer.models.parsed_instance import _remove_from_mongo,\
    xform_instances, ParsedInstance
from formshare.libs.utils import common_tags
from formshare.libs.utils.model_tools import queryset_iterator, set_uuid
