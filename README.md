...
Releases
------------
The current stable release is 2.41.0 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.41.0) 

The database signature for stable 2.41.0 is 01ddfd994185

The Docker image for stable 2.41.0 is 20241104
...
cd /opt
sudo mkdir formshare_docker_compose_20241104
cd formshare_docker_compose_20241104
sudo wget https://raw.githubusercontent.com/qlands/FormShare/stable-2.41.0/docker_compose/docker-compose.yml
...
cd /opt/formshare_docker_compose_20241104
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20241104/docker-compose.yml
