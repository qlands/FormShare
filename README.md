...
Releases
------------
The current stable release is 2.29.1 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.29.1) 

The database signature for stable 2.29.1 is 1903afedb92d

The Docker image for stable 2.29.1 is 20230930

Requires ODKTools [2.5.1](https://github.com/qlands/odktools/releases/tag/2.5.1)
...
cd /opt
sudo mkdir formshare_docker_compose_20230930
cd formshare_docker_compose_20230930
sudo wget https://raw.githubusercontent.com/qlands/FormShare/stable-2.29.1/docker_compose/docker-compose.yml
...
cd /opt/formshare_docker_compose_20230930
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20230930/docker-compose.yml
