...
def add_json_log(request, project, form, submission, json_file, log_file, status, project_of_assistant, assistant):
    new_json_log = Jsonlog(project_id=project, form_id=form, log_id=submission,
                           ...
                           enum_project=project_of_assistant, coll_id=assistant,
...
def add_json_history(request, project, form, submission, sequence, status, project_of_assistant, assistant, notes):
    new_record = Jsonhistory(project_id=project, form_id=form, log_id=submission, log_sequence=sequence,
                             log_dtime=datetime.datetime.now(), log_action=status, enum_project=project_of_assistant,
