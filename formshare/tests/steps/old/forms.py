...
def t_e_s_t_forms(test_object):
    ...
    paths = ["resources", "forms", "old", "form08_OK.xlsx"]
    resource_file = os.path.join(test_object.path, *paths)
    res = test_object.testapp.post(
        "/user/{}/project/{}/forms/add".format(
            test_object.randonLogin, test_object.project
    ...
    # This has been fixed in PyXForm 4.X where other is now added to the options
    #
    ...
    paths = ["resources", "forms", "old", "form08_OK_u.xlsx"]
    resource_file = os.path.join(test_object.path, *paths)
    ...
    paths = ["resources", "forms", "old", "form08_OK_dc.xlsx"]
    ...
    paths = ["resources", "forms", "old", "form08_OK_external.xlsx"]
