...
Releases
------------
The current stable release is 2.10.1 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.10.1) 

The database signature for stable 2.10.1 is 448376431f7b

The Docker image for stable 2.10.1 is 20211102
...
cd /opt
sudo mkdir formshare_docker_compose_20211102
cd formshare_docker_compose_20211102
sudo wget https://raw.githubusercontent.com/qlands/FormShare/stable-2.10.1/docker_compose/docker-compose.yml
...
cd /opt/formshare_docker_compose_20211102
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20211102/docker-compose.yml
