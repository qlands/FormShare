...
from formshare.apps.api.permissions import AttachmentObjectPermissions
...
from formshare.libs.serializers.attachment_serializer import AttachmentSerializer
from formshare.libs.renderers.renderers import MediaFileContentNegotiation, \
    MediaFileRenderer
...
class AttachmentViewSet(LastModifiedMixin, viewsets.ReadOnlyModelViewSet):
    ...
    > Example
    >
    >       curl -X GET https://formshare.qlands,com/api/v1/media

    > Response
    >
    >        [{
    >           "download_url": "http://formshare.qlands.com/api/v1/media/1.jpg",
    >           "small_download_url": "http://formshare.qlands.com/api/v1/media/1-small.jpg",
    >           "medium_download_url": "http://formshare.qlands.com/api/v1/media/1-medium.jpg",
    >           "filename": "doe/attachments/1408520136827.jpg",
    >           "id": 1,
    >           "instance": 1,
    >           "mimetype": "image/jpeg",
    >           "url": "http://formshare.qlands.com/api/v1/media/1",
    >           "xform": 1,
    >        }
    >        ...
    ...
    > Example
    >
    >       curl -X GET https://formshare.qlands,com/api/v1/media/1
    ...
    >
    >         curl -X GET https://formshare.qlands,com/api/v1/media/1.png -o a.png
    ...
    > Example
    >
    >     curl -X GET https://formshare.qlands,com/api/v1/media/1 -H "Accept: image/png" -o
    >     a.png
    ...
    > Example
    >
    >     curl -X GET https://formshare.qlands,com/api/v1/media?xform=1
    ...
    > Example
    >
    >     curl -X GET https://formshare.qlands,com/api/v1/media?instance=1
    ...
    > Example
    >
    >       curl -X GET https://formshare.qlands,com/api/v1/media/1?filename=doe/attachments/1408520136827.jpg

    > Response
    >
    >        http://formshare.qlands.com/api/v1/media/1.jpg
