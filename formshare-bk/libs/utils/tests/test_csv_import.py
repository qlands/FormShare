...
from formshare.libs.utils import csv_import
...
class CSVImportTestCase(TestBase):
    ...
    @mock.patch('formshare.libs.utils.csv_import.safe_create_instance')
    ...
    @mock.patch('formshare.libs.utils.csv_import.safe_create_instance')
    @mock.patch('formshare.libs.utils.csv_import.dict2xmlsubmission')
