...
from formshare.apps.logger.models import Attachment, Instance, XForm
...
from formshare.libs.utils.viewer_tools import create_attachments_zipfile,\
    image_urls
from formshare.libs.utils.common_tags import (
...
from formshare.libs.exceptions import J2XException
...
class ExportBuilder(object):
    ...
    def to_flat_csv_export(
        ...
        # TODO resolve circular import
        from formshare.apps.viewer.pandas_mongo_bridge import\
            CSVDataFrameBuilder
