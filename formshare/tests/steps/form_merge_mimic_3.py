...
def t_e_s_t_form_merge_mimic_3(test_object):
    ...
    mimic_res = test_object.testapp.post(
        ...
        {
            "coll_id": "{}|{}|{}".format(merge_project_id, "merge003", merge003_uuid),
            "coll_can_submit": "1",
            "coll_can_clean": "1",
        },
        status=302,
    ...
    test_object.testapp.post(
        ...
        extra_environ=dict(FS_for_testing="true", FS_user_for_testing="merge003"),
    )
