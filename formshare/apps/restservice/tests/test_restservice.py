...
from formshare.apps.main.views import show, link_to_bamboo
from formshare.apps.main.tests.test_base import TestBase
from formshare.apps.logger.models.xform import XForm
from formshare.apps.restservice.views import add_service, delete_service
from formshare.apps.restservice.RestServiceInterface import RestServiceInterface
from formshare.apps.restservice.models import RestService
