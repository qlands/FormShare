...
from formshare.apps.api.viewsets.charts_viewset import ChartsViewSet
from formshare.apps.api.viewsets.connect_viewset import ConnectViewSet
from formshare.apps.api.viewsets.data_viewset import DataViewSet
from formshare.apps.api.viewsets.metadata_viewset import MetaDataViewSet
from formshare.apps.api.viewsets.note_viewset import NoteViewSet
from formshare.apps.api.viewsets.organization_profile_viewset import\
    OrganizationProfileViewSet
from formshare.apps.api.viewsets.project_viewset import ProjectViewSet
from formshare.apps.api.viewsets.stats_viewset import StatsViewSet
from formshare.apps.api.viewsets.team_viewset import TeamViewSet
from formshare.apps.api.viewsets.xform_viewset import XFormViewSet
from formshare.apps.api.viewsets.user_profile_viewset import UserProfileViewSet
from formshare.apps.api.viewsets.user_viewset import UserViewSet
from formshare.apps.api.viewsets.submissionstats_viewset import\
    SubmissionStatsViewSet
from formshare.apps.api.viewsets.attachment_viewset import AttachmentViewSet
from formshare.apps.api.viewsets.xform_list_api import XFormListApi
from formshare.apps.api.viewsets.xform_submission_api import XFormSubmissionApi
from formshare.apps.api.viewsets.briefcase_api import BriefcaseApi
...
class MultiLookupRouter(routers.DefaultRouter):
    ...
    def get_api_root_view(self):
        ...
        class FormShareApi(APIView):
            """
## FormShare JSON Rest API endpoints:
...
FormShare JSON API enpoints support both Basic authentication
...
Example using curl:
    ...
    curl -X GET http://formshare.qlands.com/api/v1/ -u username:password

### Token Authentication

Example using curl:

    curl -X GET http://formshare.qlands.com/api/v1/ -H "Authorization: Token TOKEN_KEY"

### Temporary Token Authentication

Example using curl:

    curl -X GET http://formshare.qlands.com/api/v1/ -H "Authorization: TempToken TOKEN_KEY"

### FormShare Tagging API
...
## Using Oauth2 with the FormShare API

You can learn more about oauth2 [here](
http://tools.ietf.org/html/rfc6749).

### 1. Register your client application with FormShare - [register](\
...
### 4. Accessing the FormShare API using the `access_token`.

Example using curl:

    curl -X GET http://formshare.qlands.com/api/v1
