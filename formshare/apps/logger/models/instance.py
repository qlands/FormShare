...
from formshare.apps.logger.models.survey_type import SurveyType
from formshare.apps.logger.models.xform import XForm
from formshare.apps.logger.models.xform import XFORM_TITLE_LENGTH
from formshare.apps.logger.xform_instance_parser import XFormInstanceParser,\
    clean_and_parse_xml, get_uuid_from_xml
from formshare.libs.utils.common_tags import ATTACHMENTS, BAMBOO_DATASET_ID,\
    DELETEDAT, GEOLOCATION, ID, MONGO_STRFTIME, NOTES, SUBMISSION_TIME, TAGS,\
    UUID, XFORM_ID_STRING, SUBMITTED_BY, VERSION
from formshare.libs.utils.model_tools import set_uuid
