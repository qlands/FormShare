...
def upgrade():
    ...
    op.add_column('userproject', sa.Column('project_accepted', sa.INTEGER(), server_default=sa.text("'1'"), nullable=True))
    op.add_column('userproject', sa.Column('project_accepted_date', sa.DateTime(), nullable=True))
