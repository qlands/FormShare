...
def internal_build_xlsx(
    ...
    if p.returncode == 0:
        if settings.get("export.excel.with.format", "False") == "True":
            ...
            os.rename(xlsx_file_tmp, xlsx_file)
...
def build_xlsx(  # pragma: no cover
    self,
    settings,
    odk_dir,
    form_schema,
