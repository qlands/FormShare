...
The Docker image for stable 2.10.2 is 20211210
...
cd /opt
sudo mkdir formshare_docker_compose_20211210
cd formshare_docker_compose_20211210
...
cd /opt/formshare_docker_compose_20211210
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20211210/docker-compose.yml
