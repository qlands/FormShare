...
from formshare.apps.restservice.utils import call_service
from formshare.libs.utils.timing import calculate_duration
from formshare.libs.utils.common_tags import ID, UUID, ATTACHMENTS, GEOLOCATION,\
    SUBMISSION_TIME, MONGO_STRFTIME, BAMBOO_DATASET_ID, DELETEDAT, TAGS,\
    NOTES, SUBMITTED_BY, VERSION, DURATION, START_TIME, END_TIME

from formshare.libs.utils.decorators import apply_form_field_names
