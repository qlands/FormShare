...
from formshare.apps.logger.views import edit_data
from formshare.apps.logger.xform_instance_parser import get_uuid_from_xml
from formshare.libs.utils.logger_tools import inject_instanceid
