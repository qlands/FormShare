...
def upgrade():
    ...
    if bind.dialect.name == "mysql":
        op.create_table('taskmessages',
                        ...
                        sa.ForeignKeyConstraint(['celery_taskid'], ['product.celery_taskid'], name=op.f('fk_taskmessages_celery_taskid_product'), ondelete='CASCADE'),
        ...
        op.create_table('taskmessages',
                        ...
                        sa.Column('message_content', sa.UnicodeText(), nullable=True),
                        sa.ForeignKeyConstraint(['celery_taskid'], ['product.celery_taskid'],
                                                name=op.f('fk_taskmessages_celery_taskid_product'), ondelete='CASCADE'),
                        sa.PrimaryKeyConstraint('message_id', name=op.f('pk_taskmessages'))
                        )
