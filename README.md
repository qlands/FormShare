...
Releases
------------
The current stable release is 2.10.2 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.10.2) 

The database signature for stable 2.10.2 is f3467525faa2

The Docker image for stable 2.10.2 is 20211212
...
cd /opt
sudo mkdir formshare_docker_compose_20211212
cd formshare_docker_compose_20211212
sudo wget https://raw.githubusercontent.com/qlands/FormShare/stable-2.10.2/docker_compose/docker-compose.yml
...
cd /opt/formshare_docker_compose_20211212
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20211212/docker-compose.yml
