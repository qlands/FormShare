...
from formshare.libs.serializers.user_serializer import UserSerializer
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/users
...
> Example:
>
>        curl -X GET https://formshare.qlands.com/api/v1/users/demo
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/users?search=demo@email.com
