...
from formshare.libs.utils.logger_tools import dict2xml, safe_create_instance
...
def get_submission_meta_dict(xform, instance_id):
    ...
    :param formshare.apps.logger.models.XForm xform: The submission's XForm.
...
def dict2xmlsubmission(submission_dict, xform, instance_id, submission_date):
    ...
    :param formshare.apps.logger.models.XForm xfrom: The submission's XForm.
    :param string instance_id: The submission/instance `uuid`.
...
def submit_csv(username, xform, csv_file):
    ...
    :py:func:`formshare.libs.utils.logger_tools.safe_create_instance`
