...
from formshare.libs.serializers.team_serializer import TeamSerializer
from formshare.apps.api.models import Team
from formshare.apps.api.tools import add_user_to_team, remove_user_from_team
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/teams

> Response
>
>        [
>            {
>                "url": "https://formshare.qlands.com/api/v1/teams/1",
>                "name": "Owners",
>                "organization": "bruize",
>                "projects": []
>            },
>            {
>                "url": "https://formshare.qlands.com/api/v1/teams/2",
>                "name": "demo team",
>                "organization": "bruize",
>                "projects": []
>            }
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/teams/1
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/teams/1/members
