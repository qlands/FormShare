...
Releases
------------
The current stable release is 2.37.0 and it is available [here](https://github.com/qlands/FormShare/tree/stable-2.37.0) 

The database signature for stable 2.37.0 is e29a5b751eb5

The Docker image for stable 2.37.0 is 20240715
...
cd /opt
sudo mkdir formshare_docker_compose_20240715
cd formshare_docker_compose_20240715
sudo wget https://raw.githubusercontent.com/qlands/FormShare/stable-2.37.0/docker_compose/docker-compose.yml
...
cd /opt/formshare_docker_compose_20240715
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root and FormShare admin passwords
sudo nano /opt/formshare_docker_compose_20240715/docker-compose.yml
