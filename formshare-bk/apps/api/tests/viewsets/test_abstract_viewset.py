...
from formshare.apps.api.models import OrganizationProfile
...
from formshare.apps.main.models import UserProfile, MetaData
from formshare.apps.main import tests as main_tests
from formshare.apps.logger.models import Attachment
from formshare.apps.logger.models import Instance
...
from formshare.apps.logger.views import submission
