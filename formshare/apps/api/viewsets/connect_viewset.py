...
from formshare.apps.api.permissions import ConnectViewsetPermissions
from formshare.apps.main.models.user_profile import UserProfile
from formshare.libs.mixins.object_lookup_mixin import ObjectLookupMixin
from formshare.libs.mixins.last_modified_mixin import LastModifiedMixin
from formshare.libs.serializers.password_reset_serializer import \
...
from formshare.settings.common import DEFAULT_SESSION_EXPIRY_TIME
from formshare.apps.api.models.temp_token import TempToken
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/user
...
>       curl -X POST -d email=demouser@mail.com\
 url=http://example-url.com/reset https://formshare.qlands.com/api/v1/user/reset
>
> Response:
>
>        HTTP 204 OK
...
-d new_password=usernewpass https://formshare.qlands.com/api/v1/user/reset
>
> Response:
>
>        HTTP 204 OK
...
> Example
>
>       curl -X DELETE https://formshare.qlands.com/api/v1/user/expire \
-u <username>:<password>
>
> Response:
>
