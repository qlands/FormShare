...
from formshare.libs.filters import (
...
from formshare.libs.serializers.user_profile_serializer import\
    UserProfileSerializer
from formshare.libs.serializers.project_serializer import ProjectSerializer
from formshare.libs.serializers.share_project_serializer import\
...
from formshare.apps.api.permissions import ProjectPermissions
...
from formshare.settings.common import (
    DEFAULT_FROM_EMAIL,
...
>
>       {
>           "url": "https://formshare.qlands.com/api/v1/projects/1",
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/projects
...
>           },
>           {
>               "url": "https://formshare.qlands.com/api/v1/projects/4",
>               "owner": "https://formshare.qlands.com/api/v1/users/formshare",
>               "name": "project 2",
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/projects?owner=formshare
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/projects/1
...
"category": "water"}' \
https://formshare.qlands.com/api/v1/projects/1
...
>       curl -X POST -d username=alice -d role=readonly\
 https://formshare.qlands.com/api/v1/projects/1/share
...
https://formshare.qlands.com/api/v1/projects/1/forms -H "Content-Type: application/json"
...
>       curl -X POST -F xls_file=@/path/to/form.xls\
 https://formshare.qlands.com/api/v1/projects/1/forms
...
> Example
>
>       curl -X GET https://formshare.qlands.com/api/v1/projects/1/forms
...
> Request
>
>       curl -X GET https://formshare.qlands.com/api/v1/projects?tag=smart,brand+new
...
> Request
>
>       curl -X GET https://formshare.qlands.com/api/v1/projects/28058/labels
...
>
>       curl -X DELETE \
https://formshare.qlands.com/api/v1/projects/28058/labels/tag1
>
> or to delete the tag "hello world"
>
>       curl -X DELETE \
https://formshare.qlands.com/api/v1/projects/28058/labels/hello%20world
>
> Response
>
>        HTTP 200 OK
